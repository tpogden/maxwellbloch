...
field_fixed_frame = fixed.rabi_freq(
    mb_solve_00, 0, speed_of_light, part="real", interp_kind="cubic"
)
...
ax.set_ylabel(r"Rabi Frequency ($\Gamma / 2\pi $)")
...
def animate(i):
    ...
    ax.fill_between(x, 0.0, y, alpha=0.5, color=pal[2], clip_on=False, interpolate=True)
