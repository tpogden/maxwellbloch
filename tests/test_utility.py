...
class TestHalfMaxRoots(unittest.TestCase):
    def test_gaussian(self):
        ...
        t_list = tlist = np.linspace(0.0, 1.0, 101)
        y_list = t_funcs.gaussian(1)(
            tlist, args={"ampl_1": 1.0, "fwhm_1": 0.1, "centre_1": 0.5}
        )
...
class TestFullWidthAtHalfMax(unittest.TestCase):
    def test_gaussian(self):
        ...
        self.assertAlmostEqual(utility.full_width_at_half_max(t_list, y_list), 0.1)
