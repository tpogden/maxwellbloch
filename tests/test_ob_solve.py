...
class TestSetFieldRabiTFunc(unittest.TestCase):
    ...
    def test_set_field_rabi_t_func_1(self):
        ...
        def two_pulse_t_func(t, args):
            return t_funcs.gaussian(0)(t, args) + t_funcs.gaussian(1)(t, args)
...
class TestSolve(unittest.TestCase):
    def test_two_level_rabi_oscillations(self):
        ...
        RABI_FREQ = 5.0
        atom_dict = {
            "fields": [{"coupled_levels": [[0, 1]], "rabi_freq": RABI_FREQ}],
            "num_states": 2,
        }
        ...
        self.assertTrue(np.allclose(pop_0, known_0, rtol=1.0e-5, atol=1.0e-5))
        self.assertTrue(np.allclose(pop_1, known_1, rtol=1.0e-5, atol=1.0e-5))
    ...
    def test_two_level_with_opts(self):
        ...
        self.assertTrue(np.allclose(pop_0, known_0, rtol=1.0e-3, atol=1.0e-3))
        self.assertTrue(np.allclose(pop_1, known_1, rtol=1.0e-3, atol=1.0e-3))
